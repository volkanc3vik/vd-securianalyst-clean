...
(function () {
  ...
  var STYLE = ''
    ...
    + '.cc-card{background:linear-gradient(160deg,color-mix(in srgb,var(--c) 12%,rgba(8,18,33,.72)),rgba(7,16,28,.72));border:1px solid rgba(255,255,255,.10);border-radius:18px;padding:0;gap:0;overflow:hidden;text-align:center;-webkit-backdrop-filter:blur(14px);backdrop-filter:blur(14px);box-shadow:inset 0 1px 0 rgba(255,255,255,.07),inset 0 0 34px -20px rgba(255,255,255,.16),0 10px 26px -18px rgba(0,0,0,.65);transition:transform .3s,border-color .3s,box-shadow .3s}'
